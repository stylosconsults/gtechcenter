        ...
        <div className='flex flex-col mb-[3em]'>
            ...
            <div className='flex h-[450px]'>
                <div className='flex flex-col justify-center bg-headerBgColor w-[50%] px-6 gap-7 h-full '>
                    ...
                    <p className='text-welcomeBgColor'>G-WISSEN Consultsis a forward-thinking consultancy firm established in 2024 and headquartered in Kk 345 st. Founded by Fabrice Kagina, G-WISSEN Consultsis driven by innovation, integrity, and a commitment to excellence. We focus on delivering impactful solutions that drive sustainable growth for our clients.</p>
