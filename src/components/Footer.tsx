...
//                     <div className='flex flex-col gap-1 ps-4 text-headerLinkBorderColor'>
//                         <Link href={""}>KK 317 st., Kicukiro Niboyi</Link>
//                         <Link href={""}>info@example.com</Link>
//                         <Link href={""}>+250 787 919 252</Link>
//                     </div>
//                 </div>
//                 <div className='flex flex-col gap-3'>
...
const Footer = () => {
  const { loading, createSubscription, subscribeSuccessMsgs } =
    useSubscription();
  const [subscribingEmail, setSubscribingEmail] = useState<string>("");
  const [disableSubscribeBtn, setDisableSubscribeBtn] =
    ...
    <div className="flex flex-col bg-textColor">
      ...
      <div className="flex flex-col gap-4 md:gap-6 py-6 md:py-[30px] items-center bg-headerInfoBgColor px-4 md:px-0">
        ...
        <form
          ...
          className="flex w-full md:w-[50%] lg:w-[30%] rounded-[5px] overflow-hidden justify-between"
        >
          <input
            type="text"
            placeholder="Your Email"
          ...
          <button
            ...
            className={`${
              loading || disableSubscribeBtn ? "bg-slate-700" : "bg-textColor"
            } text-white w-[30%] md:w-[20%] p-2 text-sm md:text-base`}
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 px-6 md:px-10 lg:px-20 my-8 md:my-[2em]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1 ps-4 text-headerLinkBorderColor">
            <Link href="" className="hover:text-white transition-colors">
              KK 317 st., Kicukiro Niboyi
            </Link>
            <a
              href="mailto:gwissenconsult@gmail.com"
              className="hover:text-white transition-colors"
            >
              gwissenconsult@gmail.com
            </a>
            <a
              href="tel:+50788647871"
              className="hover:text-white transition-colors"
            >
              +250 787 919 252
            </a>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-3 ps-4">
            <Link
              ...
              href="https://x.com/wissen_g14898"
      ...
      <div className="my-3 px-4 md:px-0">
        <p className="text-center text-headerLinkBorderColor text-sm md:text-base">
          ©{" "}
          <span className="underline underline-offset-[5px] inline-block hover:text-white transition-colors">
            G-Wissen
          </span>
