    ...
    <div className={`${open_sans.variable}`}>
      ...
      <div className="hidden md:flex justify-between items-center bg-headerBgColor h-[35px]">
        <div className="flex items-center ps-[35px] w-[40%]">
          <Link
            className="border-r-headerLinkBorderColor border-r-2 flex justify-center w-[30%] items-center h-full text-welcomeBgColor"
          ...
          <Link
            className="flex justify-center w-[30%] h-full items-center text-welcomeBgColor"
            href="/privacy_policy"
          >
            Privacy Policy
          </Link>
        ...
        <div className="flex items-center ps-9 h-full justify-center pe-[2%] gap-[10%] text-white w-[40%] bg-headerInfoBgColor inclined-left">
          ...
          <a
            ...
            className="flex  text-[1.3vw] items-center gap-2 font-semibold"
          >
            <PhoneIcon />
            +250 787 919 252
          </a>
